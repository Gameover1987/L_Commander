...
namespace L_Commander.App.Views.DesignMock
{
    ...
    internal sealed class DesignMockMainViewModel : MainViewModel
    {
        public DesignMockMainViewModel() 
            : base(new DesignMockSettingsProvider(),new DesignMockFileManagerViewModel(), new DesignMockFileManagerViewModel(), new DesignMockCopyOperation(), new DesignMockWindowManager())
        {
        }
    }
}
